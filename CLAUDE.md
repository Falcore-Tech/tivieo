...
- `next-themes` — dark-mode toggle. `nanoid` — slug suffix. `axios` — HTTP (incl. presigned-PUT upload with progress). `class-variance-authority`, `clsx`, `tailwind-merge`, `lucide-react` — UI.
